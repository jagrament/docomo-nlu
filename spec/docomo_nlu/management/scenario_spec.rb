  ...
  describe "#scenarios" do
    ...
    it "Get all scenarios" do
      VCR.use_cassette("/management/scenario/index") do
        scenarios = DocomoNlu::Management::Scenario.all(params: { project_id: project_id, bot_id: bot_id })
    ...
    it "Get a scenario" do
      VCR.use_cassette("/management/scenario/show") do
        scenario = DocomoNlu::Management::Scenario.find("test_scenario", params: { project_id: project_id, bot_id: bot_id })
      ...
      context "Upload file" do
        it "Upload AIML" do
          VCR.use_cassette("/management/scenario/upload_aiml") do
            scenario = DocomoNlu::Management::Scenario.new(project_id: project_id, bot_id: bot_id)
