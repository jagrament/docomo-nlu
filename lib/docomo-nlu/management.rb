...
module DocomoNlu
  module Management
    ...
    module V23
      ...
      autoload :BotLogs,            "docomo-nlu/management/V23/bot_logs"
      ...
      autoload :Logs,               "docomo-nlu/management/V23/logs"
    ...
    BotLogs = const_get "DocomoNlu::Management::#{NAMESPACE}::BotLogs"
    Config = const_get "DocomoNlu::Management::#{NAMESPACE}::Config"
    Entry = const_get "DocomoNlu::Management::#{NAMESPACE}::Entry"
    Logs = const_get "DocomoNlu::Management::#{NAMESPACE}::Logs"    
